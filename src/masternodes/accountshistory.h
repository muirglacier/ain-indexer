...
public:
    ...
    Res AddBalance(CScript const & owner, CTokenAmount amount, const CDoubleReason* reason, uint32_t blockHeight) override;
    Res SubBalance(CScript const & owner, CTokenAmount amount, const CDoubleReason* reason, uint32_t blockHeight) override;
    bool Flush() override;
