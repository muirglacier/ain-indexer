...
public:
    ...
    Res AddBalance(CScript const & owner, CTokenAmount amount, const CDoubleReason* reason) override;
    Res SubBalance(CScript const & owner, CTokenAmount amount, const CDoubleReason* reason) override;
    bool Flush() override;
